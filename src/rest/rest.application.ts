...
export class RestApplication {
  ...
  private async initControllers() {
    this.server.use(ControllerPath.User, this.userController.router);
    this.server.use(ControllerPath.Offer, this.offerController.router);
    this.server.use(ControllerPath.Comment, this.commentController.router);
  }
